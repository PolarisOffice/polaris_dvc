...
pub use schema::{
    BorderRule, BulletSpec, CharShape, ColorValue, LevelType, OutlineShape, ParaNumBullet,
    ParaShape, Permission, Range64, RuleSpec, SpecialCharacter, StringList, TableSpec,
};
