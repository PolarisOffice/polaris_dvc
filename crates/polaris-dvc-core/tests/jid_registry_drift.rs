//! Drift check: every value in `crates/polaris-dvc-core/src/jid_registry.rs`
...
fn generated_jid_values_match_upstream_header() {
    ...
    let generated = fs::read_to_string(root.join("crates/polaris-dvc-core/src/jid_registry.rs"))
